...
echo "<div class=\"slide slide1 testimonial_moving_slide testimonial_moving testimonial_moving_single template-{$template_name} {$hclass} item {$has_image} cf-tr\">\n";	
echo "<section class=\"testimonial_moving_slide_inner\">";
...
if( $show_microdata ){
	...
	echo "	<div class=\"testimonial_moving_microdata\">\n";
		...
		echo "	<div class=\"reviewer\"> ";
			echo "	<div class=\"fn\"> " . wpautop($author_name) . "</div>";
			echo "	<div class=\"fn\"> " . wpautop($company) . "</div>";
